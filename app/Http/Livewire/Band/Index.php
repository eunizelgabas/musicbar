...
class Index extends Component
{
    ...
    protected $queryString = ['genre'];
    public $search;
    public $search_band = null;
    public $edit_id, $band_name, $location, $rate, $talent_fee, $founder, $description,
            $old_image, $new_image, $selectedId;
    public $genre = [], $sortBy = 'asc', $sortRate = 0,
            $bandLocation = 'all', $loc,
            $Rock, $Reggae, $Pop, $Classical, $Acoustic;

    public function mount(){
        $this->loc = Band::pluck('location')->unique()->toArray();
    }
    ...
    public function view($id){
        ...
        $booking = Booking::where('band_id', $this->band_show_id)->first();
